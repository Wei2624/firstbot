...
const FB_PAGE_TOKEN = "EAATOwRMaZCVgBAA1NKlqQF6Hz58jr3ttHGEWzcClqJbZATOyLVOZBF8YUI6PLrER9IBtWryOr3Obm3abCPijkdfMHtw1427JhexhIneziWo0i4oi8VDgI5cqIGfnjuLwrZBfFBR8IsiuOIYQWHzZAxhnL4ZC0ZAlN29AZCKvNzDgWAZDZD";
...
const actions = {
  ...
  optiongenerator({context, entities}) {
    ...
    if (user_intent == 'book') {
      ...
      context.options = JSON.stringfy(messages); 
    } 
    return context;
  },
